...
(function (P, _) {
  typeof exports == 'object' && typeof module < 'u'
    ...
    : typeof define == 'function' && define.amd
      ? define(_)
      : ((P = typeof globalThis < 'u' ? globalThis : P || self), (P.EditorjsList = _()));
})(this, function () {
  'use strict';
  const P =
  ...
  function jt(e) {
    ...
    return (
      (e = e
        ...
        .replace(/\+/gi, '+')),
      t.mac
        ? (e = e.replace(/ctrl|cmd/gi, '⌘').replace(/alt/gi, '⌥'))
        : (e = e.replace(/cmd/gi, 'Ctrl').replace(/windows/gi, 'WIN')),
      e
    );
  }
  function Tt(e) {
  ...
  function ie(e, ...t) {
    ...
    if (A(e) && A(n))
      for (const r in n)
        A(n[r]) ? (e[r] === void 0 && Object.assign(e, { [r]: {} }), ie(e[r], n[r])) : Object.assign(e, { [r]: n[r] });
    return ie(e, ...t);
  }
  function Ht(e, t, n) {
  ...
  function zt(e, t, n = void 0) {
    ...
    return function () {
      ...
      return (
        ...
        (i = arguments),
        u <= 0 || u > t
          ? (l && (clearTimeout(l), (l = null)), (s = d), (a = e.apply(r, i)), l === null && (r = i = null))
          : !l && n.trailing !== !1 && (l = setTimeout(o, u)),
        a
      );
    };
  }
  ...
  function xt(e) {
    var t, n;
    return (0, Zt.isNativeInput)(e)
      ? e.value.length
      : e.nodeType === Node.TEXT_NODE
        ? e.length
        : (n = (t = e.textContent) === null || t === void 0 ? void 0 : t.length) !== null && n !== void 0
          ? n
          : 0;
  }
  (function (e) {
  ...
  function dn(e) {
    return Array.from(e.querySelectorAll((0, un.allInputsSelector)())).reduce(function (t, n) {
      return (0, cn.isNativeInput)(n) || (0, sn.containsOnlyInlineElements)(n)
        ? D(D([], t, !0), [n], !1)
        : D(D([], t, !0), (0, on.getDeepestBlockElements)(n), !0);
    }, []);
  }
  (function (e) {
  ...
  function Cn(e, t) {
    var n = '';
    return (0, yn.isSingleTag)(e) && !(0, gn.isLineBreakTag)(e)
      ? !1
      : ((0, vn.isElement)(e) && (0, bn.isNativeInput)(e)
          ? (n = e.value)
          : e.textContent !== null && (n = e.textContent.replace('​', '')),
        t !== void 0 && (n = n.replace(new RegExp(t, 'g'), '')),
        n.trim().length === 0);
  }
  ((function (e) {
  ...
  class v {
    ...
    renderWrapper(t) {
      ...
      return (
        t === !0
          ? (n = c.make('ol', [v.CSS.wrapper, v.CSS.orderedList]))
          : (n = c.make('ol', [v.CSS.orderedList, v.CSS.itemChildren])),
        n
      );
    }
    renderItem(t, n) {
  ...
  class b {
    ...
    renderWrapper(t) {
      ...
      return (
        t === !0
          ? (n = c.make('ul', [b.CSS.wrapper, b.CSS.unorderedList]))
          : (n = c.make('ul', [b.CSS.unorderedList, b.CSS.itemChildren])),
        n
      );
    }
    renderItem(t, n) {
  ...
  function Ln(e, t, n, r, i) {
    ...
    if (
      (r === 'left' ? (l.setStart(e, 0), l.setEnd(t, n)) : (l.setStart(t, n), l.setEnd(e, e.childNodes.length)),
      i === !0)
    ) {
    ...
    if ((t === void 0 && (t = !0), (0, $n.isNativeInput)(e))) {
      ...
      if (o(u)) {
        ...
        if (o(u) && u.nodeType === Node.TEXT_NODE) {
          var h =
              (r = (n = u.textContent) === null || n === void 0 ? void 0 : n.length) !== null && r !== void 0 ? r : 0,
            i = t ? 0 : h;
  ...
  function Wn() {
    ...
    return t === null
      ...
      : (t.nodeType !== Node.TEXT_NODE &&
          ...
          (t.childNodes[n] !== void 0
            ? ((t = t.childNodes[n]), (n = 0))
            : ((t = t.childNodes[n - 1]), t.textContent !== null && (n = t.textContent.length))),
        [t, n]);
  }
  (function (e) {
  ...
  class f {
    ...
    renderWrapper(t) {
      ...
      return (
        t === !0
          ? ((n = c.make('ul', [f.CSS.wrapper, f.CSS.checklist])),
          ...
          : (n = c.make('ul', [f.CSS.checklist, f.CSS.itemChildren])),
        n
      );
    }
    renderItem(t, n) {
      ...
      return (
        n.checked === !0 && l.classList.add(f.CSS.itemChecked),
        (a.innerHTML = P),
        l.appendChild(a),
        r.appendChild(l),
        r.appendChild(i),
    ...
    toggleCheckbox(t) {
      (t.classList.toggle(f.CSS.itemChecked),
        t.classList.add(f.CSS.noHover),
        t.addEventListener('mouseleave', () => this.removeSpecialHoverBehavior(t), { once: !0 }));
    }
  ...
  function y(e, t = !0) {
    let n = e;
    return (
      e.classList.contains(p.item) && (n = e.querySelector(`.${p.itemChildren}`)),
      n === null
        ? []
        : t
          ? Array.from(n.querySelectorAll(`:scope > .${p.item}`))
          : Array.from(n.querySelectorAll(`.${p.item}`))
    );
  }
  function Vn(e) {
  ...
  class $e {
    ...
    render() {
      return (
        ...
        this.data.items.length
          ...
          : this.appendItems([{ content: '', meta: {}, items: [] }], this.listWrapper),
        this.readOnly ||
        ...
        'start' in this.data.meta && this.data.meta.start !== void 0 && this.changeStartWith(this.data.meta.start),
    ...
    save(t) {
      ...
      return (
        this.data.style === 'ordered' &&
          (a.meta = { start: this.data.meta.start, counterType: this.data.meta.counterType }),
        a
      );
    }
    ...
    merge(t) {
      ...
      if (
        r === null ||
        i === null ||
        (i.insertAdjacentHTML('beforeend', t.items[0].content), this.listWrapper === void 0)
      )
        return;
      ...
      o !== void 0 &&
        (o.items.length !== 0 && (s === null && (s = this.renderer.renderWrapper(!1)), this.appendItems(o.items, s)),
        t.items.length > 0 && this.appendItems(t.items, this.listWrapper));
    }
    onPaste(t) {
    ...
    pasteHandler(t) {
      ...
      const l = (s) =>
        Array.from(s.querySelectorAll(':scope > li')).map((d) => {
    ...
    backspace(t) {
      ...
      if (
        n !== null &&
        j.isCaretAtStartOfInput(n) &&
        ((r = window.getSelection()) == null ? void 0 : r.isCollapsed) !== !1
      ) {
    ...
    splitList(t) {
      ...
      const s = this.save(l);
      ((s.meta.start = this.data.style == 'ordered' ? 1 : void 0),
        this.api.blocks.insert(r == null ? void 0 : r.name, s, this.config, i + 1),
        this.convertItemToDefaultBlock(i + 1),
        l.remove());
    }
    splitItem(t) {
    ...
    convertItemToDefaultBlock(t, n) {
      ...
      (n === !0 && this.api.blocks.delete(),
        t !== void 0 ? (r = this.api.blocks.insert(void 0, { text: a }, void 0, t)) : (r = this.api.blocks.insert()),
        i == null || i.remove(),
  ...
  function Jn(e, { value: t, placeholder: n, attributes: r, sanitize: i }) {
    ...
    return (
      ...
      l.addEventListener('input', () => {
        ...
        (!s &&
          !a.classList.contains(I.startWithElementWrapperInvalid) &&
          a.classList.add(I.startWithElementWrapperInvalid),
          s &&
            a.classList.contains(I.startWithElementWrapperInvalid) &&
            a.classList.remove(I.startWithElementWrapperInvalid),
          s && e(l.value));
      }),
      a
    );
  ...
  function er(e) {
    return (
      typeof e.items[0] != 'string' &&
      'text' in e.items[0] &&
      'checked' in e.items[0] &&
      typeof e.items[0].text == 'string' &&
      typeof e.items[0].checked == 'boolean'
    );
  }
  function tr(e) {
    const t = [];
  ...
  class z {
    ...
    static get toolbox() {
      return [
        { icon: Be, title: 'Unordered List', data: { style: 'unordered' } },
        { icon: We, title: 'Ordered List', data: { style: 'ordered' } },
    ...
    constructor({ data: t, config: n, api: r, readOnly: i, block: a }) {
      ...
      ((this.api = r),
        ...
        (this.config = n),
        (this.block = a),
        (this.defaultListStyle = ((s = this.config) == null ? void 0 : s.defaultStyle) || 'unordered'),
        (this.defaultCounterTypes = this.config.counterTypes || Array.from(T.values())));
      const l = { style: this.defaultListStyle, meta: {}, items: [] };
      ((this.data = Object.keys(t).length ? tr(t) : l),
    ...
    renderSettings() {
      ...
      if (this.listStyle === 'ordered') {
        ...
        (T.forEach((a, l) => {
          const s = T.get(l);
          this.defaultCounterTypes.includes(s) &&
          ...
          i.children.items.length > 1 && r.push(i),
          t.push({ type: 'separator' }, ...r));
      }
      return t;
    }
    onPaste(t) {
    ...
    changeTabulatorByStyle() {
      switch (this.listStyle) {
        case 'ordered':
          this.list = new $e(
            { data: this.data, readOnly: this.readOnly, api: this.api, config: this.config, block: this.block },
