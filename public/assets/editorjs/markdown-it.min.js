...
!(function (t, e) {
  ...
  class R {
    ...
    emitNumericEntity(t, e) {
      ...
      if (this.consumed <= e)
        return (
          null === (r = this.errors) || void 0 === r || r.absenceOfDigitsInNumericCharacterReference(this.consumed),
          0
        );
    ...
    emitNamedEntityData(t, e, r) {
      ...
      switch (this.state) {
        ...
        case B.NumericStart:
          return (
            null === (t = this.errors) || void 0 === t || t.absenceOfDigitsInNumericCharacterReference(this.consumed),
            0
          );
        case B.EntityStart:
          return 0;
              ...
              if ('link_close' !== u.type) {
                if (
                  ...
                  for (let e = 0; e < i.length; e++) {
                    ...
                    ((h.attrs = [['href', s]]), (h.level = a++), (h.markup = 'linkify'), (h.info = 'auto'), c.push(h));
      ...
      function (t, e, r, n) {
        ...
        for (
          ...
          if (
            ...
            !(t.sCount[h] - t.blkIndent >= 4 || ((s = t.skipChars(s, o)), s - u < c || ((s = t.skipSpaces(s)), s < i)))
          ) {
            p = !0;
            break;
          }
