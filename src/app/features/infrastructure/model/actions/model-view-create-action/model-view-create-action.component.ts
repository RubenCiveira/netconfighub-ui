...
@Component({
  selector: 'model-view-create-action',
  standalone: false,
  templateUrl: './model-view-create-action.component.html',
  styleUrl: './model-view-create-action.component.scss',
})
export class ModelViewCreateActionComponent implements Action {
  ...
  title = signal<string>('Creando nuevo model');
  ...
  form = new FormControl<Model | undefined>(undefined);
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.create', {}, 'infrastructure/model').subscribe((val) => {
      if (val.label) {
