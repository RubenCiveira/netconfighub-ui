...
@Component({
  selector: 'model-view-edit-action',
  standalone: false,
  templateUrl: './model-view-edit-action.component.html',
  styleUrl: './model-view-edit-action.component.scss',
})
export class ModelViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'infrastructure/model').subscribe((val) => {
      if (val.label) {
