...
@Component({
  selector: 'config-template-view-search',
  templateUrl: './config-template-view-search.component.html',
  styleUrls: ['./config-template-view-search.component.scss'],
  providers: BaseEditable.getValidableAccessorProvider(ConfigTemplateViewSearchComponent),
  standalone: false,
})
export class ConfigTemplateViewSearchComponent extends SubFormEditable<any> {
