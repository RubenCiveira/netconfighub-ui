...
export class ConfigTemplateRepository {
  ...
  public static metadata(api: ApiService): RepositoryMetadata<ConfigTemplate, ConfigTemplateFilter> {
    return {
      key: 'uid',
      ...
      provider: new ApiProvider(
        'uid',
        api,
        'http://net-civeira-netconfighub/infrastructure/config-templates',
        'http://net-civeira-netconfighub/me/acl/infrastructure/config-templates',
      ),
