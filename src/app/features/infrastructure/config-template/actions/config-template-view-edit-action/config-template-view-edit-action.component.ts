...
@Component({
  selector: 'config-template-view-edit-action',
  standalone: false,
  templateUrl: './config-template-view-edit-action.component.html',
  styleUrl: './config-template-view-edit-action.component.scss',
})
export class ConfigTemplateViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'infrastructure/config-template').subscribe((val) => {
      if (val.label) {
