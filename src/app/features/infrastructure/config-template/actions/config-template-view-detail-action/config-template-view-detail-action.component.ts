...
@Component({
  selector: 'config-template-view-detail-action',
  standalone: false,
  templateUrl: './config-template-view-detail-action.component.html',
  styleUrl: './config-template-view-detail-action.component.scss',
})
export class ConfigTemplateViewDetailActionComponent implements Action {
  ...
  constructor(transloco: TranslocoService) {
    transloco.selectTranslateObject('action.detail', {}, 'infrastructure/config-template').subscribe((val) => {
      if (val.label) {
