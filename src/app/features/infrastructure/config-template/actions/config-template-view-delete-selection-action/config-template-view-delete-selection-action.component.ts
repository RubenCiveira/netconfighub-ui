...
@Component({
  selector: 'config-template-view-delete-selection-action',
  standalone: false,
  templateUrl: './config-template-view-delete-selection-action.component.html',
  styleUrl: './config-template-view-delete-selection-action.component.scss',
})
export class ConfigTemplateViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco
      .selectTranslateObject('action.delete-selection', {}, 'infrastructure/config-template')
      .subscribe((val) => {
        if (val.label) {
  ...
  private deleteSelection(items: ConfigTemplate[]) {
