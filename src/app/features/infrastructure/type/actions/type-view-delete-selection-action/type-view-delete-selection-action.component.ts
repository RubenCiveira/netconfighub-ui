...
@Component({
  selector: 'type-view-delete-selection-action',
  standalone: false,
  templateUrl: './type-view-delete-selection-action.component.html',
  styleUrl: './type-view-delete-selection-action.component.scss',
})
export class TypeViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'infrastructure/type').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: Type[]) {
