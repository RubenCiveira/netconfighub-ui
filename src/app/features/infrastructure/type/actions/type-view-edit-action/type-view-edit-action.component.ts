...
@Component({
  selector: 'type-view-edit-action',
  standalone: false,
  templateUrl: './type-view-edit-action.component.html',
  styleUrl: './type-view-edit-action.component.scss',
})
export class TypeViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'infrastructure/type').subscribe((val) => {
      if (val.label) {
