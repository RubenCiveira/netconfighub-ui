...
export class TypeRepository {
  ...
  public static metadata(api: ApiService): RepositoryMetadata<Type, TypeFilter> {
    return {
      key: 'uid',
      name: 'type',
      provider: new ApiProvider(
        'uid',
        api,
        'http://net-civeira-netconfighub/infrastructure/types',
        'http://net-civeira-netconfighub/me/acl/infrastructure/types',
      ),
