...
@Component({
  selector: 'vendor-view-delete-selection-action',
  standalone: false,
  templateUrl: './vendor-view-delete-selection-action.component.html',
  styleUrl: './vendor-view-delete-selection-action.component.scss',
})
export class VendorViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'infrastructure/vendor').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: Vendor[]) {
