...
@Component({
  selector: 'vendor-view-edit-action',
  standalone: false,
  templateUrl: './vendor-view-edit-action.component.html',
  styleUrl: './vendor-view-edit-action.component.scss',
})
export class VendorViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'infrastructure/vendor').subscribe((val) => {
      if (val.label) {
