...
@Component({
  selector: 'vendor-view-detail-action',
  standalone: false,
  templateUrl: './vendor-view-detail-action.component.html',
  styleUrl: './vendor-view-detail-action.component.scss',
})
export class VendorViewDetailActionComponent implements Action {
  ...
  constructor(transloco: TranslocoService) {
    transloco.selectTranslateObject('action.detail', {}, 'infrastructure/vendor').subscribe((val) => {
      if (val.label) {
