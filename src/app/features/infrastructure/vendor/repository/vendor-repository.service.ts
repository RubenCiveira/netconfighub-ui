...
export class VendorRepository {
  ...
  public static metadata(api: ApiService): RepositoryMetadata<Vendor, VendorFilter> {
    return {
      key: 'uid',
      name: 'vendor',
      provider: new ApiProvider(
        'uid',
        api,
        'http://net-civeira-netconfighub/infrastructure/vendors',
        'http://net-civeira-netconfighub/me/acl/infrastructure/vendors',
      ),
