...
@Component({
  selector: 'device-instance-view-delete-selection-action',
  standalone: false,
  templateUrl: './device-instance-view-delete-selection-action.component.html',
  styleUrl: './device-instance-view-delete-selection-action.component.scss',
})
export class DeviceInstanceViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'installations/device-instance').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: DeviceInstance[]) {
