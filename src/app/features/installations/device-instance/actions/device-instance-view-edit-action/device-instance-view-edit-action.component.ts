...
@Component({
  selector: 'device-instance-view-edit-action',
  standalone: false,
  templateUrl: './device-instance-view-edit-action.component.html',
  styleUrl: './device-instance-view-edit-action.component.scss',
})
export class DeviceInstanceViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'installations/device-instance').subscribe((val) => {
      if (val.label) {
