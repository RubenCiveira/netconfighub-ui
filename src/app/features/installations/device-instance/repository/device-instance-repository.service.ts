...
export class DeviceInstanceRepository {
  ...
  public static metadata(api: ApiService): RepositoryMetadata<DeviceInstance, DeviceInstanceFilter> {
    return {
      key: 'uid',
      ...
      provider: new ApiProvider(
        'uid',
        api,
        'http://net-civeira-netconfighub/installations/device-instances',
        'http://net-civeira-netconfighub/me/acl/installations/device-instances',
      ),
