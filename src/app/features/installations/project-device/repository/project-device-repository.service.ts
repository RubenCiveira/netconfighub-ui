...
export class ProjectDeviceRepository {
  ...
  public static metadata(api: ApiService): RepositoryMetadata<ProjectDevice, ProjectDeviceFilter> {
    return {
      key: 'uid',
      name: 'project-device',
      provider: new ApiProvider(
        'uid',
        api,
        'http://net-civeira-netconfighub/installations/project-devices',
        'http://net-civeira-netconfighub/me/acl/installations/project-devices',
      ),
  ...
  displayProvider(): DisplayProvider<ProjectDevice> {
    return {
