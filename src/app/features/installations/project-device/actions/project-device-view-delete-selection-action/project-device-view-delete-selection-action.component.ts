...
@Component({
  selector: 'project-device-view-delete-selection-action',
  standalone: false,
  templateUrl: './project-device-view-delete-selection-action.component.html',
  styleUrl: './project-device-view-delete-selection-action.component.scss',
})
export class ProjectDeviceViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'installations/project-device').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: ProjectDevice[]) {
