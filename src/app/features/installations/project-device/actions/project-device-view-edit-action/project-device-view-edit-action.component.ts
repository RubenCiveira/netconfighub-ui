...
@Component({
  selector: 'project-device-view-edit-action',
  standalone: false,
  templateUrl: './project-device-view-edit-action.component.html',
  styleUrl: './project-device-view-edit-action.component.scss',
})
export class ProjectDeviceViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'installations/project-device').subscribe((val) => {
      if (val.label) {
