...
@Component({
  selector: 'project-view-edit-action',
  standalone: false,
  templateUrl: './project-view-edit-action.component.html',
  styleUrl: './project-view-edit-action.component.scss',
})
export class ProjectViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'installations/project').subscribe((val) => {
      if (val.label) {
