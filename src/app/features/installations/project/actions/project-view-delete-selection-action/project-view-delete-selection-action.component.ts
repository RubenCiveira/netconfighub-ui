...
@Component({
  selector: 'project-view-delete-selection-action',
  standalone: false,
  templateUrl: './project-view-delete-selection-action.component.html',
  styleUrl: './project-view-delete-selection-action.component.scss',
})
export class ProjectViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'installations/project').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: Project[]) {
