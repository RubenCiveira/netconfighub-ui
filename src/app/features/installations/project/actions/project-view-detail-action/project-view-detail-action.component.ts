...
@Component({
  selector: 'project-view-detail-action',
  standalone: false,
  templateUrl: './project-view-detail-action.component.html',
  styleUrl: './project-view-detail-action.component.scss',
})
export class ProjectViewDetailActionComponent implements Action {
  ...
  constructor(transloco: TranslocoService) {
    transloco.selectTranslateObject('action.detail', {}, 'installations/project').subscribe((val) => {
      if (val.label) {
