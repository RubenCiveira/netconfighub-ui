...
@Component({
  selector: 'device-check-view-edit-action',
  standalone: false,
  templateUrl: './device-check-view-edit-action.component.html',
  styleUrl: './device-check-view-edit-action.component.scss',
})
export class DeviceCheckViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'installations/device-check').subscribe((val) => {
      if (val.label) {
