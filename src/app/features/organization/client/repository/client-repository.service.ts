...
export class ClientRepository {
  ...
  public static metadata(api: ApiService): RepositoryMetadata<Client, ClientFilter> {
    return {
      key: 'uid',
      name: 'client',
      provider: new ApiProvider(
        'uid',
        api,
        'http://net-civeira-netconfighub/organization/clients',
        'http://net-civeira-netconfighub/me/acl/organization/clients',
      ),
