...
@Component({
  selector: 'client-view-edit-action',
  standalone: false,
  templateUrl: './client-view-edit-action.component.html',
  styleUrl: './client-view-edit-action.component.scss',
})
export class ClientViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'organization/client').subscribe((val) => {
      if (val.label) {
