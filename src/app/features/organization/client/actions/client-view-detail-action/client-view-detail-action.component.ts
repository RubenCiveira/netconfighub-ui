...
@Component({
  selector: 'client-view-detail-action',
  standalone: false,
  templateUrl: './client-view-detail-action.component.html',
  styleUrl: './client-view-detail-action.component.scss',
})
export class ClientViewDetailActionComponent implements Action {
  ...
  constructor(transloco: TranslocoService) {
    transloco.selectTranslateObject('action.detail', {}, 'organization/client').subscribe((val) => {
      if (val.label) {
