...
@Component({
  selector: 'client-view-delete-selection-action',
  standalone: false,
  templateUrl: './client-view-delete-selection-action.component.html',
  styleUrl: './client-view-delete-selection-action.component.scss',
})
export class ClientViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'organization/client').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: Client[]) {
