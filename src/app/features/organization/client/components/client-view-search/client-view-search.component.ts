...
@Component({
  selector: 'client-view-search',
  templateUrl: './client-view-search.component.html',
  styleUrls: ['./client-view-search.component.scss'],
  providers: BaseEditable.getValidableAccessorProvider(ClientViewSearchComponent),
  standalone: false,
})
export class ClientViewSearchComponent extends SubFormEditable<any> {
