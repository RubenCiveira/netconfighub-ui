...
@Component({
  selector: 'site-view-delete-selection-action',
  standalone: false,
  templateUrl: './site-view-delete-selection-action.component.html',
  styleUrl: './site-view-delete-selection-action.component.scss',
})
export class SiteViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'organization/site').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: Site[]) {
