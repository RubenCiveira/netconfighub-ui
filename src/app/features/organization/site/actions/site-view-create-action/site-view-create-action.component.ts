...
@Component({
  selector: 'site-view-create-action',
  standalone: false,
  templateUrl: './site-view-create-action.component.html',
  styleUrl: './site-view-create-action.component.scss',
})
export class SiteViewCreateActionComponent implements Action {
  ...
  title = signal<string>('Creando nuevo site');
  ...
  form = new FormControl<Site | undefined>(undefined);
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.create', {}, 'organization/site').subscribe((val) => {
      if (val.label) {
