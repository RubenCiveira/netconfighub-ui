...
@Component({
  selector: 'site-view-detail-action',
  standalone: false,
  templateUrl: './site-view-detail-action.component.html',
  styleUrl: './site-view-detail-action.component.scss',
})
export class SiteViewDetailActionComponent implements Action {
  ...
  constructor(transloco: TranslocoService) {
    transloco.selectTranslateObject('action.detail', {}, 'organization/site').subscribe((val) => {
      if (val.label) {
