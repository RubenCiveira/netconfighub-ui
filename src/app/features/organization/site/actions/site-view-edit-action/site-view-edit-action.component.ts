...
@Component({
  selector: 'site-view-edit-action',
  standalone: false,
  templateUrl: './site-view-edit-action.component.html',
  styleUrl: './site-view-edit-action.component.scss',
})
export class SiteViewEditActionComponent implements Action {
  readonly name = 'edit';
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.edit', {}, 'organization/site').subscribe((val) => {
      if (val.label) {
