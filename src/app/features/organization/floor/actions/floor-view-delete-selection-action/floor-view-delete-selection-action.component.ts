...
@Component({
  selector: 'floor-view-delete-selection-action',
  standalone: false,
  templateUrl: './floor-view-delete-selection-action.component.html',
  styleUrl: './floor-view-delete-selection-action.component.scss',
})
export class FloorViewDeleteSelectionActionComponent implements Action, OnDestroy {
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.delete-selection', {}, 'organization/floor').subscribe((val) => {
      if (val.label) {
  ...
  private deleteSelection(items: Floor[]) {
