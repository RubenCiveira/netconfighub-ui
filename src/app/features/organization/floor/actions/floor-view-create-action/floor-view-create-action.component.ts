...
@Component({
  selector: 'floor-view-create-action',
  standalone: false,
  templateUrl: './floor-view-create-action.component.html',
  styleUrl: './floor-view-create-action.component.scss',
})
export class FloorViewCreateActionComponent implements Action {
  ...
  title = signal<string>('Creando nuevo floor');
  ...
  constructor(
    ...
    transloco.selectTranslateObject('action.create', {}, 'organization/floor').subscribe((val) => {
      if (val.label) {
