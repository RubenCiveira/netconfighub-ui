...
(function (J, ne) {
  typeof exports == 'object' && typeof module < 'u'
    ...
    : typeof define == 'function' && define.amd
      ? define(ne)
      : ((J = typeof globalThis < 'u' ? globalThis : J || self), (J.EditorJS = ne()));
})(this, function () {
  'use strict';
  var J =
    typeof globalThis < 'u'
  ...
  function tt() {}
  (Object.assign(tt, { default: tt, register: tt, revert: function () {}, __esModule: !0 }),
    ...
    Element.prototype.scrollIntoViewIfNeeded ||
      (Element.prototype.scrollIntoViewIfNeeded = function (n) {
        ...
        ((s || r) && n && (e.scrollTop = this.offsetTop - e.offsetTop - e.clientHeight / 2 - o + this.clientHeight / 2),
          (a || l) &&
            n &&
            (e.scrollLeft = this.offsetLeft - e.offsetLeft - e.clientWidth / 2 - i + this.clientWidth / 2),
  ...
  function ot(n, e, t = void 0) {
    ...
    return function () {
      ...
      return (
        ...
        (i = arguments),
        u <= 0 || u > e
          ? (r && (clearTimeout(r), (r = null)), (a = c), (s = n.apply(o, i)), r || (o = i = null))
  ...
  function nt(n, ...e) {
    ...
    if (N(n) && N(t))
      for (const o in t)
        N(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), nt(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
    return nt(n, ...e);
  }
  function it(n) {
    const e = Qn();
      ...
      return !i || !i.anchorNode || !i.focusNode
        ...
        : ([i.anchorNode, i.focusNode].forEach((a) => {
            ...
            for (
              ...
              l > 0 &&
              a.parentNode &&
              !(a.tagName === e && ((s = a), t && a.classList && !a.classList.contains(t) && (s = null), s));
  ...
  function ai(n, e) {
    ...
    return n.type === 'attributes' && n.attributeName === 'data-empty'
      ...
      : !!(
          e.contains(o) ||
          (t === 'childList' && (Array.from(i).some((l) => l === e) || Array.from(s).some((l) => l === e)))
        );
  }
  ...
  class R extends we {
    ...
    getTunes() {
      ...
      return (
        d.isElement(o) ? e.push({ type: _.Html, element: o }) : Array.isArray(o) ? e.push(...o) : e.push(o),
  ...
  class ci extends E {
    constructor() {
      (super(...arguments),
        (this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, a) => {
        ...
        (this.insertMany = (e, t = this.Editor.BlockManager.blocks.length - 1) => {
          ...
          const o = e.map(({ id: i, type: s, data: r }) =>
            this.Editor.BlockManager.composeBlock({ id: i, tool: s || this.config.defaultBlock, data: r }),
          );
      ...
      return (function (t) {
        ...
        return (
          ...
          (i.t = function (s, r) {
            ...
            if (
              (i.r(a), Object.defineProperty(a, 'default', { enumerable: !0, value: s }), 2 & r && typeof s != 'string')
            )
              for (var l in s)
                i.d(
                  a,
              ...
              (s.i = function (r, a) {
                ...
                for (c = 0; c < r.length; c++) {
                  ...
                  (typeof h[0] == 'number' && l[h[0]]) ||
                    (a && !h[2] ? (h[2] = a) : a && (h[2] = '(' + h[2] + ') and (' + a + ')'), s.push(h));
                }
              }),
              s
            );
...
/*# sourceMappingURL=data:application/json;base64,` +
                          btoa(unescape(encodeURIComponent(JSON.stringify(vo)))) +
                          ' */'));
          ...
          t.exports = function (k, m) {
            ...
            (((m = m || {}).attrs = typeof m.attrs == 'object' ? m.attrs : {}),
              m.singleton || typeof m.singleton == 'boolean' || (m.singleton = l()),
...
`)
          ...
          t.exports = function (i) {
            ...
            return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (l, c) {
              ...
              return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(h)
                ? l
                : ((u = h.indexOf('//') === 0 ? h : h.indexOf('/') === 0 ? r + h : a + h.replace(/^\.\//, '')),
            ...
            (p = 'cdx-notify__btns-wrapper'),
            {
              ...
              confirm: function (f) {
                ...
                return (
                  ...
                  S.classList.add(l),
                  A.classList.add(c),
                  j && typeof j == 'function' && (A.addEventListener('click', j), G.addEventListener('click', j)),
        ...
        function (t, o, i) {
          ...
          class s {
            ...
            loadStyles() {
              ...
              const l = i(2),
                c = this.make('style', null, { textContent: l.toString(), id: a });
  ...
  const $o = class _e {
    ...
    leafNodesAndReturnIndex(e) {
      ...
      let t = this.cursor;
      return (
        t === -1 ? (t = e === _e.directions.RIGHT ? -1 : 0) : this.items[t].classList.remove(this.focusedCssClass),
        e === _e.directions.RIGHT
          ? (t = (t + 1) % this.items.length)
          : (t = (this.items.length + t - 1) % this.items.length),
        d.canSetCaret(this.items[t]) && Ae(() => b.setCursor(this.items[t]), 50)(),
  ...
  class ae {
    ...
    handleEnterPress(e) {
      this.activated &&
        ...
        M(this.activateCallback) && this.activateCallback(this.iterator.currentItem));
    }
    flipCallback() {
    ...
    constructor(e) {
      ((this.nodes = {
        ...
        e.description !== void 0 &&
          ((this.nodes.description = d.make('div', Te.description, { textContent: e.description })),
  ...
  class le extends pt {
    ...
    make(e, t) {
      ...
      return (
        ...
        (this.nodes.icon = d.make('div', [L.icon, L.iconTool], { innerHTML: e.icon || Ki })),
        ...
        this.hasChildren && i.appendChild(d.make('div', [L.icon, L.iconChevronRight], { innerHTML: Ui })),
    ...
    enableSpecialHoverAndFocusBehavior() {
      ...
      ((e = this.nodes.root) == null || e.classList.add(L.noHover),
        ...
        (o = this.nodes.root) == null ||
          o.addEventListener('mouseleave', this.removeSpecialHoverBehavior, { once: !0 }));
    }
  ...
  class Wo extends pt {
    constructor() {
      (super(),
        (this.nodes = { root: d.make('div', gt.container), line: d.make('div', gt.line) }),
  ...
  class Xo extends we {
    constructor(e, t = {}) {
      (super(),
        ...
        (this.nodes.nothingFoundMessage = d.make('div', [P.nothingFoundMessage], {
  ...
  class os extends we {
    constructor({ items: e, placeholder: t }) {
      ...
      ((this.input = d.make('input', bt.input, { placeholder: t, tabIndex: -1 })),
        this.wrapper.appendChild(o),
        this.wrapper.appendChild(this.input),
        this.listeners.on(this.input, 'input', () => {
          ((this.searchQuery = this.input.value),
            this.emit(De.Search, { query: this.searchQuery, items: this.foundItems }));
        }));
    }
    getElement() {
      return this.wrapper;
  ...
  var ns = Object.defineProperty,
    ...
    ss = (n, e, t, o) => {
      for (var i = o > 1 ? void 0 : o ? is(e, t) : e, s = n.length - 1, r; s >= 0; s--)
  ...
  const Vo = class zn extends Xo {
      ...
      (super(e, t),
        ...
        (this.onSearch = (o) => {
          ...
          (this.items.forEach((l) => {
            let c = !1;
            (l instanceof le ? (c = !o.items.includes(l)) : (l instanceof Wo || l instanceof Se) && (c = s || !i),
              l.toggleHidden(c));
          }),
        ...
        this.nestingLevel > 0 && this.nodes.popover.classList.add(P.popoverNested),
    ...
    show() {
      var e;
      (this.nodes.popover.style.setProperty(me.PopoverHeight, this.size.height + 'px'),
        this.shouldOpenBottom || this.nodes.popover.classList.add(P.popoverOpenTop),
        this.shouldOpenRight || this.nodes.popover.classList.add(P.popoverOpenLeft),
        super.show(),
    ...
    showNestedPopoverForItem(e) {
      ...
      return (
        ...
        t.style.setProperty(me.NestingLevel, this.nestedPopover.nestingLevel.toString()),
    ...
    addSearch() {
      ((this.search = new os({ items: this.itemsDefault, placeholder: this.messages.search })),
  ...
  class rs extends vt {
    constructor(e) {
      ...
      (super(
        ...
        {
          [_.Default]: { wrapperTag: 'button', hint: { position: 'top', alignment: 'center', enabled: t } },
    ...
    show() {
      (this.nestingLevel === 0 && this.nodes.popover.style.setProperty(me.InlinePopoverWidth, this.size.width + 'px'),
        super.show());
    }
    handleHover() {}
    setTriggerItemPosition(e, t) {
  ...
  class Zo extends Xo {
    constructor(e) {
      (super(e, { [_.Default]: { hint: { enabled: !1 } }, [_.Html]: { hint: { enabled: !1 } } }),
  ...
  class vs extends E {
    ...
    async make() {
      ((this.nodes.wrapper = d.make('div', this.CSS.toolbar)),
        ...
        (this.nodes.plusButton = d.make('div', this.CSS.plusButton, { innerHTML: qi })),
      ...
      const t = d.make('div'),
        ...
        i = await bs('Slash', '/');
      (t.appendChild(o),
        t.appendChild(d.make('div', this.CSS.plusButtonShortcut, { textContent: it(`CMD + ${i}`) })),
  ...
  var ce = ((n) => ((n[(n.Block = 0)] = 'Block'), (n[(n.Inline = 1)] = 'Inline'), (n[(n.Tune = 2)] = 'Tune'), n))(
      ce || {},
    ),
    je = ((n) => (
      (n.Shortcut = 'shortcut'),
    ...
    He = ((n) => ((n.IsInline = 'isInline'), (n.Title = 'title'), (n.IsReadOnlySupported = 'isReadOnlySupported'), n))(
      He || {},
    ),
  ...
  class xt {
    ...
    get settings() {
      ...
      return (
        this.isDefault && !('placeholder' in e) && this.defaultPlaceholder && (e.placeholder = this.defaultPlaceholder),
        e
      );
    }
    reset() {
  ...
  class ks extends E {
    ...
    allowedToShow() {
      ...
      return !s || this.getTools().some((c) => s.tool.inlineTools.has(c.name)) === !1
        ? !1
    ...
    getTools() {
      ...
      return e
        ? Array.from(e.tool.inlineTools.values()).filter(
            (o) => !(this.Editor.ReadOnly.isEnabled && o.isReadOnlySupported !== !0),
          )
        : [];
    }
        ...
        ([s].flat().forEach((c) => {
          ...
          if (d.isElement(c)) {
            ...
            ('children' in g && t !== 0 && e.push({ type: _.Separator }),
              e.push(g),
              'children' in g && t < this.tools.size - 1 && e.push({ type: _.Separator }));
          }
        }),
          t++);
      }
  ...
  function Dt(n, ...e) {
    ...
    if (Ye(n) && Ye(t))
      for (const o in t)
        Ye(t[o]) ? (n[o] === void 0 && Object.assign(n, { [o]: {} }), Dt(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
    return Dt(n, ...e);
  }
  function zs(n, e, t) {
    const o = `«${e}» is deprecated and will be removed in the next major release. Please use the «${t}» instead.`;
  ...
  function Vs(n, e, t = void 0) {
    ...
    return function () {
      ...
      return (
        ...
        (i = arguments),
        u <= 0 || u > e
          ? (r && (clearTimeout(r), (r = null)), (a = c), (s = n.apply(o, i)), r === null && (o = i = null))
          : !r && t.trailing !== !1 && (r = setTimeout(l, u)),
        s
      );
    };
  ...
  function or(n) {
    ...
    return (0, tr.isNativeInput)(n)
      ...
      : n.nodeType === Node.TEXT_NODE
        ? n.length
        : (t = (e = n.textContent) === null || e === void 0 ? void 0 : e.length) !== null && t !== void 0
          ? t
          : 0;
  }
  (function (n) {
  ...
  function Lr(n, e, t, o, i) {
    ...
    if (
      (o === 'left' ? (r.setStart(n, 0), r.setEnd(e, t)) : (r.setStart(e, t), r.setEnd(n, n.childNodes.length)),
      i === !0)
    ) {
    ...
    if ((e === void 0 && (e = !0), (0, Dr.isNativeInput)(n))) {
      ...
      if (l(u)) {
        ...
        if (l(u) && u.nodeType === Node.TEXT_NODE) {
          var h =
              (o = (t = u.textContent) === null || t === void 0 ? void 0 : t.length) !== null && o !== void 0 ? o : 0,
            i = e ? 0 : h;
    ...
    return e === null
      ...
      : (e.nodeType !== Node.TEXT_NODE &&
          ...
          (e.childNodes[t] !== void 0
            ? ((e = e.childNodes[t]), (t = 0))
            : ((e = e.childNodes[t - 1]), e.textContent !== null && (t = e.textContent.length))),
        [e, t]);
  }
  (function (n) {
  ...
  class Zr extends E {
    ...
    arrowRightAndDown(e) {
      ...
      const { currentBlock: o } = this.Editor.BlockManager,
        s =
          ((o == null ? void 0 : o.currentInput) !== void 0 ? ze(o.currentInput) : void 0) ||
    ...
    arrowLeftAndUp(e) {
      ...
      const { currentBlock: t } = this.Editor.BlockManager,
        i =
          ((t == null ? void 0 : t.currentInput) !== void 0 ? $e(t.currentInput) : void 0) ||
          this.Editor.BlockSelection.anyBlockSelected;
  ...
  class Qr extends E {
    ...
    insert({
      ...
      return (
        ...
        s ? (this.currentBlockIndex = l) : l <= this.currentBlockIndex && this.currentBlockIndex++,
        c
      );
    }
    insertMany(e, t = 0) {
    ...
    move(e, t = this.currentBlockIndex) {
      ...
      (this._blocks.move(e, t),
        ...
        this.blockDidMutated(Gr, this.currentBlock, { fromIndex: t, toIndex: e }));
    }
    async convert(e, t, o) {
...
`),
  ...
  class ta extends E {
    ...
    get isCrossBlockSelectionStarted() {
      return (
        !!this.firstSelectedBlock && !!this.lastSelectedBlock && this.firstSelectedBlock !== this.lastSelectedBlock
      );
    }
  ...
  const Ln = class Wn extends E {
    ...
    getFilesConfig(e) {
      ...
      (!o && !i) ||
        (o &&
          !Array.isArray(o) &&
          (T(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), (o = [])),
        i &&
          !Array.isArray(i) &&
          (T(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), (i = [])),
        i &&
          (i = i.filter((s) =>
            Jn(s) ? !0 : (T(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, 'warn'), !1),
          )),
    ...
    getPatternsConfig(e) {
      e.pasteConfig === !1 ||
        ...
        Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
          (o instanceof RegExp ||
            T(`Pattern ${o} for «${e.name}» Tool is skipped because it should be a Regexp instance.`, 'warn'),
    ...
    async processFile(e) {
      const t = Gn(e),
        o = Object.entries(this.toolsFiles).find(([r, { mimeTypes: a, extensions: l }]) => {
        ...
        if (e.length === 0) i.insert();
          ...
          const s = e.map(({ type: r, data: a, tunes: l, id: c }) => {
            ...
            try {
              ...
              (T(`Block «${r}» skipped because of plugins error`, 'error', { data: a, error: h }),
                (a = this.composeStubDataForTool(r, a, c)),
                (r = o.stubTool),
                (u = i.composeBlock({ id: c, tool: r, data: a, tunes: l })));
            }
   ...
   */ class po {
    ...
    constructor({ data: e, config: t, api: o, readOnly: i }) {
      ((this.api = o),
        ...
        (this._placeholder = t.placeholder ? t.placeholder : po.DEFAULT_PLACEHOLDER),
        (this._data = e ?? {}),
        (this._element = null),
  ...
  class mo {
    ...
    enterPressed(e) {
      ...
      if (!this.validateURL(t)) {
        (this.notifier.show({ message: 'Pasted link is not valid.', style: 'error' }),
  ...
  var fa = Object.defineProperty,
    ...
    Rn = (n, e, t, o) => {
      for (var i = o > 1 ? void 0 : o ? ga(e, t) : e, s = n.length - 1, r; s >= 0; s--)
        (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  ...
  class Hn extends E {
    ...
    assignInlineToolsToBlockTool(e) {
      if (this.config.inlineToolbar !== !1) {
        ...
        Array.isArray(e.enabledInlineTools) &&
          (e.inlineTools = new F(['convertTo', ...e.enabledInlineTools].map((t) => [t, this.inlineTools.get(t)])));
      }
    }
    ...
    prepareConfig() {
      ...
      for (const t in this.config.tools)
        N(this.config.tools[t]) ? (e[t] = this.config.tools[t]) : (e[t] = { class: this.config.tools[t] });
      return e;
    }
  }
  ...
  class wa extends E {
    ...
    bindReadOnlyInsensitiveListeners() {
      (this.listeners.on(document, 'selectionchange', this.selectionChangeDebounced),
        this.listeners.on(window, 'resize', this.resizeDebouncer, { passive: !0 }),
        this.listeners.on(this.nodes.redactor, 'mousedown', this.documentTouchedListener, { capture: !0, passive: !0 }),
      ...
      this.readOnlyMutableListeners.on(
        ...
        ot((t) => {
          ...
          this.Editor.BlockSelection.anyBlockSelected ||
            (o &&
              e !== o &&
              ((e = o), this.eventsDispatcher.emit(Qo, { block: this.Editor.BlockManager.getBlockByChildNode(o) })));
        }, 20),
        { passive: !0 },
      );
    }
    ...
    selectionChanged() {
      ...
      ((i === null || i.closest(`.${b.CSS.editorWrapper}`) !== this.nodes.wrapper) &&
  ...
  class xa {
    ...
    set configuration(e) {
      ...
      (N(e) ? (this.config = { ...e }) : (this.config = { holder: e }),
        ...
        st(!!this.config.initialBlock, 'config.initialBlock', 'config.defaultBlock'),
