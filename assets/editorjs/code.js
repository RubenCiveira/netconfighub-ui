...
(function (i, o) {
  typeof exports == 'object' && typeof module < 'u'
    ...
    : typeof define == 'function' && define.amd
      ? define(o)
      : ((i = typeof globalThis < 'u' ? globalThis : i || self), (i.CodeTool = o()));
})(this, function () {
  'use strict';
  function i(h, t) {
    let s = '';
...
` && (t += 1),
   ...
   */ class l {
    ...
    constructor({ data: t, config: e, api: s, readOnly: r }) {
      ((this.api = s),
        (this.readOnly = r),
        (this.placeholder = this.api.i18n.t(e.placeholder || l.DEFAULT_PLACEHOLDER)),
        (this.CSS = {
    ...
    save(t) {
      return { code: t.querySelector('textarea').value };
    }
    onPaste(t) {
      const e = t.detail;
      if ('data' in e) {
    ...
    drawView() {
      ...
      return (
        ...
        e.classList.add(this.CSS.textarea, this.CSS.input),
        (e.value = this.data.code),
        (e.placeholder = this.placeholder),
        this.readOnly && (e.disabled = !0),
        t.appendChild(e),
